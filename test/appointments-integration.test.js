...
// test/campaigns-integration.test.js (A1b).
//
// Porté depuis feature/acquisition-os (lot A2c, commit 7c94571) vers cette
// base d'intégration — PAR PORTAGE MANUEL, pas par cherry-pick (voir
// M0c5) : server/app.js a évolué indépendamment ici (Diagnostic 360,
// Campaigns), et le commentaire d'origine référençait la migration « v9 »,
// obsolète sur cette base (schéma v16, voir docs/MIGRATIONS.md « Version
...
// chaîne de migrations jusqu'à v16 sur cette base temporaire (attendu),
// jamais sur une base réelle ni sur data/**.
