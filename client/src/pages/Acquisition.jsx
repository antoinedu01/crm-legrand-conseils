    ...
    <>
      ...
      <div className="tiles mb">
        ...
        <div className="tile">
          <div className="label">Commissions attendues</div>
          <div className="value">
            {summaryQ.loading ? '…' : summaryQ.error ? '—' : fmtCHF(summaryQ.data.commissions.expected_amount)}
          </div>
          {!summaryQ.loading && !summaryQ.error && (
            <div className="hint">{fmtCHF(summaryQ.data.commissions.received_amount)} encaissés</div>
          )}
        </div>
        <div className="tile">
