// Rendez-vous (Acquisition OS) — routeur isolé.
//
// Porté depuis feature/acquisition-os (lot A2b, commit 4b6bcb0) vers cette
// base d'intégration — PAR PORTAGE MANUEL, pas par cherry-pick : le
// commentaire d'origine référençait la migration v9 (numéro attribué sur
// la branche historique), alors que le schéma `appointments` porte ici le
// numéro 16 (voir docs/MIGRATIONS.md, « Version 16 », et M0c3). Seule cette
// référence de numéro de version a été corrigée ; aucune autre ligne,
// aucune logique n'a été modifiée par rapport au commit d'origine.
//
// Ce fichier n'est PAS monté dans server/app.js à ce stade. Aucune UI,
// aucune intégration pipeline. Le schéma `appointments` (migration v16,
