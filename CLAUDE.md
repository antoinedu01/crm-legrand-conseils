...
> **Note (30/08/2026)** : ce fichier a été créé le 24/07/2026 sur
> `feature/marketing-ai-90-days`, première branche de la lignée marketing.
> Le travail marketing a ensuite continué sur plusieurs branches
> successives (`feature/seo-content-factory-v1`,
> `feature/marketing-acquisition-consolidation-v1`,
> `feature/marketing-source-verification-v1`,
> `feature/marketing-source-reconciliation-v1`) qui n'avaient pas repris ce
> fichier, faisant de la référence `CLAUDE.md § 6quater` citée dans
> plusieurs revues de conformité de ces branches un renvoi vers un fichier
> absent de leur arborescence. Ce fichier est reporté ici depuis
> `feature/marketing-ai-90-days` pour corriger ces références pendantes, à
> l'occasion de la consolidation du 30/08/2026 qui fusionne
> `feature/marketing-source-reconciliation-v1` (lignée la plus complète et
> la plus récente) dans la présente branche de travail. Le contenu normatif
> des règles ci-dessous (§2 à §6quater) n'a pas été modifié sur le fond.
...
| `claude/legrand-conseils-status-tigurq` | **Branche de travail courante** — reçoit la consolidation marketing du 30/08/2026 | Toute la phase marketing se fait ici jusqu'à nouvelle consolidation. Fusion vers la production seulement sur feu vert humain explicite. |
...
- Aucune fusion de branche marketing vers la production sans validation humaine
  explicite, quelle que soit la branche de travail marketing du moment.
