# Sources officielles à vérifier — affirmations du LOT 2A

> Brouillon marketing (LOT 2B). Recense les affirmations des contenus du LOT 2A qui
> nécessitent encore une vérification. Rédigé par `compliance-reviewer` le
> 16/07/2026. **Aucune source n'est présentée comme consultée intégralement
> lorsqu'elle ne l'a pas été.** Ce document n'est ni un avis juridique, ni une
> validation FINMA.
>
> Contexte technique du 16/07/2026 : les **extraits de recherche** (domaines
> officiels) ont été obtenus, mais l'**accès direct aux pages** a été refusé
> (HTTP 403) → **lecture intégrale impossible**. La vérification humaine devra donc
> relire les pages complètes.

| # | Affirmation | Contenu concerné | Organisme à consulter | Source déjà consultée | Lecture complète possible | Dernière consultation | Vérif. humaine requise | Statut |
|---|---|---|---|---|---|---|---|---|
| 1 | Le 3e pilier comprend le 3a (« lié ») et le 3b (« libre ») | LinkedIn 17/08, carrousel 18/08, reel 21/08, guide | ch.ch | Oui (extrait de recherche) | Non (accès direct refusé) | 16/07/2026 | Oui | `Consulté (extrait) — lecture complète requise` |
| 2 | Le 3a bénéficie d'un traitement fiscal particulier (cotisations déductibles) | LinkedIn 17/08, guide, reel | ch.ch / AFC | Oui (extrait de recherche) | Non | 16/07/2026 | Oui | `Consulté (extrait) — lecture complète requise` |
| 3 | Le retrait du 3a est encadré / conditions ; le 3b est plus libre | Guide, LinkedIn 17/08 | ch.ch / Fedlex | Oui (extrait de recherche) | Non | 16/07/2026 | Oui | `Consulté (extrait) — lecture complète requise` |
| 4 | Le système suisse repose sur trois piliers (1er AVS étatique ; 2e LPP professionnel ; 3e privé/facultatif) | Guide, reel | ch.ch / OFAS | Oui (extrait de recherche) | Non | 16/07/2026 | Oui | `Consulté (extrait) — lecture complète requise` |
| 5 | Finalité de chaque pilier (besoins vitaux / maintien du niveau de vie / complément) | Guide | ch.ch / OFAS | Oui (extrait de recherche) | Non | 16/07/2026 | Oui | `Consulté (extrait) — lecture complète requise` |
...
- **Aucun chiffre** (plafond, taux, prime, déduction, délai) ne doit être publié
  sans **source officielle récente + date réelle de consultation**. Les contenus du
...
- **Pages officielles à relire intégralement** (accès direct bloqué le 16/07) :
  ...
  - FINMA — obligations des intermédiaires / registre public
  - OFAS — couverture des indépendants (à identifier)
  - OFSP — assurance maladie du nouveau-né (à identifier)
