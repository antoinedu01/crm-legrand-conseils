...
le logo et le slogan « Comprendre. Choisir. Protéger. » — ou, si disponible, une
photo professionnelle sobre d'Antoine Legrand (le visage humanise un post de
...
## Version 2 — Page entreprise Legrand conseils Sàrl
...
### Hashtags (max 5)
#assurance #prévoyance #3epilier #Vaud #Genève

### Visuel recommandé (éléments existants)
**Logo + slogan sur fond de marque** (déclinaison de la bannière de la page,
format 1200 × 627) — la page étant institutionnelle, le visuel de marque est
...
- **Ordre de publication conseillé** (décision humaine) : d'abord le **profil
  personnel** (canal prioritaire), puis la version page entreprise le lendemain ou
  quelques heures plus tard — pas simultanément, pour éviter le doublon dans les
  fils des mêmes abonnés. La page peut ensuite **repartager** le post personnel.
- **Date de diffusion** : à décider par l'humain (le calendrier prévoit le
  lancement des publications à partir du 17/08/2026 ; un post de lancement peut
  légitimement précéder — décision humaine, hors périmètre de ce brouillon).
- Les deux textes n'insèrent **aucun lien** vers le site : les URL du site ne sont
  pas encore confirmées. Un lien pourra être ajouté en commentaire après
  confirmation (`URL cible à confirmer`).
- Passage obligatoire par `../../templates/checklist-finale-avant-publication.md`
  avant programmation manuelle.
